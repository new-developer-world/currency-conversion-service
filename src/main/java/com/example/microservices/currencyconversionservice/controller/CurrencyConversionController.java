...
public class CurrencyConversionController {
	...
	public CurrencyConversion calCurrencyConversion(@PathVariable String from, @PathVariable String to,
	...
	public CurrencyConversion calCurrencyConversionFeign(@PathVariable String from, @PathVariable String to,
			@PathVariable BigDecimal quantity) {
